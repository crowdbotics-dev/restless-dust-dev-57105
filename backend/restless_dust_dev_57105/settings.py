"""
Django settings for restless_dust_dev_57105 project.
...
ROOT_URLCONF = 'restless_dust_dev_57105.urls'
...
WSGI_APPLICATION = 'restless_dust_dev_57105.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_dust_dev_57105 API",
    "DESCRIPTION": "API documentation for restless_dust_dev_57105 App",
    "VERSION": "v1",
}
